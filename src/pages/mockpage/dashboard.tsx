                        ...
                        <div style={{display: "flex", justifyContent: "space-between", width: "100%"}}>
                            <div style={{display: "flex", flexDirection: "column", gap: "12px"}}>
                                ...
                                <div className={`${styles.analyse} analyse`}>
                                    ...
                                    <div style={{borderRadius: "44px"}} className="bg-primary border border-1 border-white border-opacity-50 col-xxl-3 row justify-content-center align-items-center">
